    ...
    <div class="container">     
        <div class="row">
            ...
            <div class="col-6 col-md-2">
                <div class="align-end">
                    <select name="sort" id="sort" class="form-control" form="searchForm">
                    ...
                    <div class="card border-0 shadow p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check mb-2"> 
                                <input class="form-check-input " name="job_type" type="checkbox" value="{{$jobType->id}}" id="job-type-{{$jobType->id}}" {{(in_array($jobType->id, $jobTypeArray)) ? 'checked' : ''}}>    
...
$('#searchForm').on('submit', function(e){
    e.preventDefault();
    var url = "{{route('jobs', isset($job) ? $job : '')}}?";
