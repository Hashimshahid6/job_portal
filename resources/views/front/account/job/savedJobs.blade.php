                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr class="active">
                                        ...
                                        <td>
                                            @if($savedJob->job && $savedJob->job->applications)
                                                {{ $savedJob->job->applications->count() }} Applications
                                            @else
                                                0 Applications
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="javascript:void(0);" onclick="removeJob({{$savedJob->id}})" ><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
